...
describe("POST /api/scores", () => {
  ...
  it("should return 'ignored' if the submitted score is worse than existing one", async () => {
    const res = await agent
      .post("/api/scores")
  ...
  it("should return 'updated' if the submitted score is better than existing one", async () => {
    const res = await agent
      .post("/api/scores")
